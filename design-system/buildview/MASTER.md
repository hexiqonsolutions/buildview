...
| Accent/CTA | `#A4CF30` | `--color-accent` / `brand-accent` |
...
**Color Notes:** Industrial slate surfaces + **BuildView lime `#A4CF30`** as the brand CTA (overrides the skill’s default safety-orange recommendation). Use lime for accents, active nav bars, and progress — not orange.
